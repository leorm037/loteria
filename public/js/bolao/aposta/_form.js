$('#bolao_aposta_form_dezenasMarcar').on('change', function () {
    ...
    for (var i = 0; i < dezenasQuantidade; i++) {
        var html = '<div class="col-3 col-md-2 mb-3"><input type="number" id="bolao_aposta_form_dezenas_' + i + '" name="bolao_aposta_form[dezenas][' + i + ']" required="required" min="0" max="0" class="form-control" value="0"></div>';
    ...
    $('#bolao_aposta_form_dezenas').find('input').first().focus();
