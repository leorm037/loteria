...
class BolaoApostaVoter extends Voter
{
    ...
    {
        return \in_array($attribute, [self::NEW, self::EDIT, self::DELETE]) && $subject instanceof Aposta;
    }
    ...
    private function canNew(Aposta $aposta, Usuario $usuario): bool
    {
        return $usuario === $aposta->getBolao()->getUsuario();
    }
